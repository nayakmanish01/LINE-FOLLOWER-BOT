...
Serial.println("rIGHT TURN");
   ...
   // **************  SEGEMNAT 1 **********************
if((s1 == 1) && (s2 ==0 ) && (s3 == 1) && (s4 == 0) && (s5 == 1)) // straight
  {

     analogWrite(e1, 230); //you can adjust the speed of the motors from 0-255/#######************************************
    analogWrite(e2, 225);
...
Serial.println("normaL LEFT");
  ...
  if((s1 == 1) && (s2 == 1) && (s3 == 1) && (s4 == 1) && (s5 == 0))
  {
    //going left with full speed 
    analogWrite(e1, 255); //you can adjust the speed of the motors from 0-255
    analogWrite(e2, 230); //you can adjust the speed of the motors from 0-255/############################****************************************************
    digitalWrite(m1, HIGH);
    digitalWrite(m2, LOW);
    digitalWrite(m3, LOW);
...
// rreverse condition going forward...............................................................................
  {
  ...
  if((s1 ==0 ) && (s2 ==1 ) && (s3 == 0) && (s4 == 1) && (s5 == 0)) // straight
  //SEGMENT 10#################%%%$%%^&*(^&
  {
